...
public class FingerPrintAuthenticator extends AppCompatActivity {
    ...
    private static final String KEY_NAME = "my life sucks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finger_print_authenticator);
        ...
        if (!fingerprintManager.isHardwareDetected())
            Toast.makeText(this, "Sorry, Fingerprint Permission is not Enabled", Toast.LENGTH_SHORT).show();
        else {
            if (!fingerprintManager.hasEnrolledFingerprints())
                Toast.makeText(this, "Sorry, You don't seem to have Registered this Course. Contact your Proctor", Toast.LENGTH_SHORT).show();
            else {
